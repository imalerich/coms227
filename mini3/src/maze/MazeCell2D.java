...
public class MazeCell2D implements MazeCell
{
   ...
   * Status of this cell.
   */
  // NOTE: this should be the only mutable data that may be accessed by 
  // both the main thread and an external observer (the observer
  // of the maze that this cell belongs to).
