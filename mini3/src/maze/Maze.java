...
public class Maze implements MazeObserver
{
   ...
   * in this maze.
   */
  // This will be set by an external component, such as a UI, after
  // the maze is constructed.
  private volatile MazeObserver observer;
  ...
  public Maze(String[] rows)
  {
    ...
    for (int row = 0; row < height; ++row)
    {
      for (int col = 0; col < width; ++col)
      {
        ...
        {
          // add edges from this to neighbors, in order top, left, bottom, right
